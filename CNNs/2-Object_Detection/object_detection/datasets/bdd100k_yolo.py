...
class BDD100kDataset(Dataset):  # for training/testing
    ...
    def __getitem__(self, idx):
        ...
        for i in range(num_objs):
            ...
            normalized_bbox = albu.augmentations.bbox_utils.normalize_bbox((coordinates['x1'],coordinates['y1'],
            ...
            labels_ori.append([lbl_mapped, cx, cy, bbox_w, bbox_h])
